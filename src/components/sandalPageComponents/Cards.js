...
import sandalStyle from './Cards.module.css';

const Cards = () => {
  return (
    <div>
      <h2 className='text-center mt-5 fs-1'>الأصناف</h2>
      <div className={sandalStyle.container}>
        <div className={sandalStyle.card}>
          <div className={sandalStyle.card_image}>
            <img
              className={sandalStyle.img}
              src='/images/sandal3.png'
              alt='coal'
            />
          </div>
